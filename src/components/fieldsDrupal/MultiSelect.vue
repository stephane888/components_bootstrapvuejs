...
-->
<template>
  <div :class="classCss" type-field-render="MultiSelect" :type-field-drupal="field.type">
    <MultiSelectTaxo
      v-if="field.definition_settings && field.definition_settings.target_type == 'taxonomy_term'"
      :field="field"
      :model="model"
    ...
    <MultiSelectEntities
      v-else-if="field.definition_settings && field.definition_settings.target_type != 'taxonomy_term'"
      :field="field"
      :model="model"
      :namespace-store="namespaceStore"
      :parent-name="parentName"
